...
const defaultPasswordMeterQuires: IPasswordMeterQueries = {
...
class PasswordMeterComponent {
  ...
  public static getInstance = (
    el: HTMLElement,
    componentName: string = defaultPasswordMeterQuires.componentName
  ) => {
  ...
  public static createInstances = (
    selector: string = defaultPasswordMeterQuires.instanceQuery,
    options: IPasswordMeterOptions = defaultPasswordMeterOptions,
    queries: IPasswordMeterQueries = defaultPasswordMeterQuires
  ) => {
  ...
  public static bootstrap = (selector: string = defaultPasswordMeterQuires.instanceQuery) => {
...
export {PasswordMeterComponent, defaultPasswordMeterOptions, defaultPasswordMeterQuires}

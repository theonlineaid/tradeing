...
const defaultSwapperQuires: ISwapperQueries = {
...
class SwapperComponent {
  ...
  public static getInstance = (
    el: HTMLElement,
    componentName: string = defaultSwapperQuires.componentName
  ...
  public static createInstances = (
    selector: string = defaultSwapperQuires.instanceQuery,
    options: ISwapperOptions = defaultSwapperOptions,
    queries: ISwapperQueries = defaultSwapperQuires
  ) => {
  ...
  public static bootstrap = (selector: string = defaultSwapperQuires.instanceQuery) => {
    SwapperComponent.createInstances(selector)
  }

  public static reinitialization = (selector: string = defaultSwapperQuires.instanceQuery) => {
    SwapperComponent.createInstances(selector)
  }
}
...
window.addEventListener('resize', function () {
  ...
  throttle(
    ...
    () => {
      ...
      const elements = document.querySelectorAll(defaultSwapperQuires.instanceQuery)
      elements.forEach((el) => {
...
export {SwapperComponent, defaultSwapperOptions, defaultSwapperQuires}

...
const defaultImageInputQuires: IImageInputQueries = {
...
class ImageInputComponent {
  ...
  public static getInstance = (
    el: HTMLElement,
    componentName: string = defaultImageInputQuires.componentName
  ) => {
  ...
  public static createInstances = (
    selector: string = defaultImageInputQuires.instanceQuery,
    options: IImageInputOptions = defaultImageInputOptions,
    queries: IImageInputQueries = defaultImageInputQuires
  ) => {
  ...
  public static bootstrap = (selector: string = defaultImageInputQuires.instanceQuery) => {
    ImageInputComponent.createInstances(selector)
  }

  public static reinitialization = (selector: string = defaultImageInputQuires.instanceQuery) => {
    ImageInputComponent.createInstances(selector)
  }
}
export {ImageInputComponent, defaultImageInputOptions, defaultImageInputQuires}

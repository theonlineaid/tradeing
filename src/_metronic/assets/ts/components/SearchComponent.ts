...
const defaultSearchQuires: ISearchQueries = {
...
class SearchComponent {
  ...
  public static getInstance = (
    el: HTMLElement,
    componentName: string = defaultSearchQuires.componentName
  ) => {
  ...
  public static createInstances = (
    selector: string = defaultSearchQuires.instanceQuery,
    options: ISearchOptions = defaultSearchOptions,
    queries: ISearchQueries = defaultSearchQuires
  ) => {
  ...
  public static bootstrap = (selector: string = defaultSearchQuires.instanceQuery) => {
    SearchComponent.createInstances(selector)
  }

  public static reinitialization = (selector: string = defaultSearchQuires.instanceQuery) => {
    SearchComponent.createInstances(selector)
  }
}
export {SearchComponent, defaultSearchOptions, defaultSearchQuires}

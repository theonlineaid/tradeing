...
const defaultAlerts: Array<AlertModel> = [
  ...
  },
  {
    ...
    time: '2 hrs',
    icon: 'icons/duotune/general/gen018.svg',
    state: 'danger',
  },
  {
    title: 'Company HR',
...
const themesOptions: Array<ThemeModel> = [
  {
    id: 'default',
    title: 'Default Theme',
    description: "It's default theme",
    btnSave: 'Save',
    btnReset: 'Reset',
    icon: 'icons/duotune/technology/teh008.svg',
    state: 'primary',

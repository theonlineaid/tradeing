...
const PositionBody = ({checkData, layout, getCsvData, setSelectedInstrument, fontSize}) => {
  // States
  ...
  const [data, setData] = useState<any>([
    {scrip: 'RUNNERAUTO.XDSE', lpt: '1085', high: '35054', low: '48.4 BDT'},
    {scrip: 'RUNNERAUTO', lpt: '50110BDT', high: '', low: '48.4'},
    {scrip: 'TEST.XDSE', lpt: '1085', high: '135054', low: '48.4 BDT'},
  ...
  const handleRowData = () => {
    ...
    const marketMatched =
      linkedTable?.marketData === linkedTable?.position && linkedTable?.position !== ''
    const blotterMatched =
      linkedTable?.blotter === linkedTable?.position && linkedTable?.position !== ''
    const deptMatched =
      linkedTable?.marketDept === linkedTable?.position && linkedTable?.position !== ''
    const movGenMatched =
      linkedTable?.moversGainers === linkedTable?.position && linkedTable?.position !== ''
    const orderSumMatched =
      linkedTable?.orderSummary === linkedTable?.position && linkedTable?.position !== ''

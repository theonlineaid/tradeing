...
import {PROFIT_LIST_INIT_VALUE} from '../../../../constants'
import SectionHeader from '../../../section-headers'
import ProfitList from './../Profit/Profit'

const Profit = (props: any) => {
  // hooks
  const {checkData, handleCheckData} = useTableHook({
    initData: PROFIT_LIST_INIT_VALUE,
  })

  // states
  const [selectedTab, setSelectedTab] = useState<string>('profit')

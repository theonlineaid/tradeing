...
const CreateAppModal: React.FC<React.PropsWithChildren<Props>> = ({show, handleClose}) => {
                      ...
                      <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
                        <span className='d-flex align-items-center me-2'>
                          ...
                          <span className='d-flex flex-column'>
                            ...
                            <span className='fs-7 text-muted'>Base Web Project</span>
                          </span>
                        </span>
                      ...
                      <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
                        <span className='d-flex align-items-center me-2'>
                          ...
                          <span className='d-flex flex-column'>
                            ...
                            <span className='fs-7 text-muted'>Powerful data management</span>
                          </span>
                        </span>
